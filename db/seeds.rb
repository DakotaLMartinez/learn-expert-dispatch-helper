...
questions = Question.create([
  { 
    time_asked: DateTime.new(2017,2,9,17,25,0,Rational(-5,24)),
  ...
  { 
    time_asked: DateTime.new(2017,2,9,17,30,0,Rational(-5,24)),
    question_type: 'Chat-Dispatch', 
  ...
  { 
    ...
    start_share: DateTime.new(2017,2,9,17,48,0,Rational(-5,24)),
    end_share: DateTime.new(2017,2,9,18,9,0,Rational(-5,24)),
    question_link: 'https://learn.co/lessons/14102?batch_id=306&track_id=12615&question_id=48640' 
  },
  { 
    time_asked: DateTime.new(2017,2,9,17,34,0,Rational(-5,24)),
    question_type: 'Chat-Dispatch', 
  ...
  { 
    time_asked: DateTime.new(2017,2,9,17,35,0,Rational(-5,24)),
    question_type: 'SS', 
  ...
  { 
    time_asked: DateTime.new(2017,2,9,17,45,0,Rational(-5,24)),
    question_type: 'Chat-Dispatch', 
  ...
  { 
    time_asked: DateTime.new(2017,2,9,17,58,0,Rational(-5,24)),
    question_type: 'SS', 
